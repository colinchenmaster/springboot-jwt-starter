...
<table>
  <tr>
    ...
    <td>
      UNITTEST:If you want to quickly add token based authentication to your apps, feel free to check out Auth0's SDKs and free plan at <a href="https://auth0.com/overview?utm_source=GHsponsor&utm_medium=GHsponsor&utm_campaign=springboot-jwt&utm_content=auth">auth0.com/overview</a>.
    </td>
  </tr>
</table>
